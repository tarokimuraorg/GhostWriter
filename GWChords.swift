...
class GWChords : GWChordsProtocol {
    ...
    public static func of(_ scale : GWScale.Major) -> GWDegrees {
        
        let notes = GWNotes.of(scale)
        
        return GWDegrees(I: notes[0], II: notes[1] + "m", III: notes[2] + "m", IV: notes[3], V: notes[4], VI: notes[5] + "m", VII: notes[6] + "m7-5")
        
    }
    
    public static func of(_ scale : GWScale.NaturalMinor) -> GWDegrees {
    ...
    public static func of(_ scale : GWScale.HarmonicMinor) -> GWDegrees{
    ...
    public static func of(_ scale : GWScale.MelodicMinor) -> GWDegrees {
